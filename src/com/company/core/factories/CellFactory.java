...
public class CellFactory implements CellularFactory {
    private static final String CELLS_PACKAGE_NAME =
            "com.company.models.cells.";

    @Override
    public Cellular createUnit(String cellType, String cellId, int health, int positionRow, int positionCol, int additionalProperty) throws ExecutionControl.NotImplementedException, NoSuchMethodException, ClassNotFoundException, IllegalAccessException, InvocationTargetException, InstantiationException {
